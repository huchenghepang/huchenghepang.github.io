<template><div><h1 id="nginx反向代理服务器" tabindex="-1"><a class="header-anchor" href="#nginx反向代理服务器"><span>nginx反向代理服务器</span></a></h1>
<h2 id="_1-安装nginx服务器" tabindex="-1"><a class="header-anchor" href="#_1-安装nginx服务器"><span>1.安装<code v-pre>nginx</code>服务器</span></a></h2>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h2 id="_2-配置nginx的选项" tabindex="-1"><a class="header-anchor" href="#_2-配置nginx的选项"><span>2.配置nginx的选项</span></a></h2>
...
<span class="line">        }</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-启动nginx服务器" tabindex="-1"><a class="header-anchor" href="#_3-启动nginx服务器"><span>3. 启动<code v-pre>nginx</code>服务器：</span></a></h2>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-关闭nginx服务器" tabindex="-1"><a class="header-anchor" href="#_4-关闭nginx服务器"><span>4. 关闭<code v-pre>nginx</code>服务器</span></a></h2>
...
<span class="line"></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-重启nginx服务器" tabindex="-1"><a class="header-anchor" href="#_5-重启nginx服务器"><span>5. 重启nginx服务器</span></a></h2>
<p>查看当前进程号：</p>
